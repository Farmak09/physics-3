...
bool PhysBody::Contains(int x, int y) const
{
	...
	for (b2Fixture* fixture = body->GetFixtureList(); fixture; fixture = body->GetFixtureList()->GetNext())
	{
		ret = fixture->TestPoint(point);
		break;
	}
...
int PhysBody::RayCast(int x1, int y1, int x2, int y2, float& normal_x, float& normal_y) const
{
	...
	b2RayCastInput dummyInput;

	dummyInput.maxFraction = 1;
	dummyInput.p1 = p1;
	dummyInput.p2 = p2;

	b2RayCastInput &input = dummyInput;
...
{
	PhysBody* ba = (PhysBody*)contact->GetFixtureA()->GetBody()->GetUserData();
}
// TODO 3
